...
function LuggageBag({
  ...
  return (
    <button
      ...
      className="baggage-card flex-shrink-0 w-[360px] text-left overflow-visible rounded-lg border-2 border-[var(--floor-line)] bg-[var(--terminal-dark)] touch-manipulation"
    >
      ...
      <span className="bag-tag" aria-hidden>{origin}</span>
        ...
        <div className="w-full h-40 overflow-hidden rounded bg-[var(--terminal-blue)]/40 border border-[var(--floor-line)] mb-2">
          {image ? (
